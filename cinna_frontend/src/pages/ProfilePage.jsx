...
const s = {
  ...
  imageBtn:       { padding: '0.35rem 0.75rem', backgroundColor: '#d4922a', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: '0.75rem', fontWeight: 600 },
  ...
  editBtn:        { padding: '0.4rem 0.9rem', backgroundColor: '#d4922a', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: '0.85rem', fontWeight: 600 },
