// src/pages/manufacturer/MyTendersPage.jsx
...
const s = {
  ...
  addBtn:{padding:'0.55rem 1.25rem',backgroundColor:'#d4922a',color:'#fff',border:'none',borderRadius:7,cursor:'pointer',fontSize:'0.9rem',fontWeight:600},
