...
export default function AdminGradingReports() {
  ...
  return (
    <AdminLayout>
      ...
      <div style={s.toolbar}>
        <input style={s.search} placeholder="🔍  Search by manufacturer or tender…" value={search} onChange={e => setSearch(e.target.value)} />
...
const s = {
  ...
  gradeCard:  { flex: 1, minWidth: 90, backgroundColor: '#fff', borderRadius: 10, padding: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', cursor: 'pointer' },
