...
const styles = {
  ...
  errorText:         { display: 'block', color: '#e74c3c', fontSize: '0.85rem', marginTop: '0.25rem' },
  submitBtn: {
    width: '100%', padding: '0.875rem', backgroundColor: '#27ae60',
    color: '#fff', border: 'none', borderRadius: '8px',
    fontSize: '1rem', fontWeight: '600', cursor: 'pointer',
    transition: 'all 0.3s', marginTop: '1rem',
  },
  submitBtnDisabled: { backgroundColor: '#95a5a6', cursor: 'not-allowed' },
  errorAlert: {
    backgroundColor: '#fee', color: '#c33', padding: '0.875rem',
    borderRadius: '8px', marginBottom: '1.25rem', border: '1px solid #fcc',
    fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem',
  },
  errorIcon: { fontSize: '1.2rem' },
  footer:    { marginTop: '1.5rem', textAlign: 'center', color: '#7f8c8d', fontSize: '0.9rem' },
  linkBtn: {
    background: 'none', border: 'none', color: '#3498db',
    cursor: 'pointer', fontSize: '0.9rem', fontWeight: '500',
    marginLeft: '0.25rem', padding: '0.25rem', textDecoration: 'underline',
  },
};
